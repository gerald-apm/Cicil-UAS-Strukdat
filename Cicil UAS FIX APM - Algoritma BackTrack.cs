...
namespace Cicilan_UAS_Backtrack
{
    ...
    public class SingleLink
    {
        ...
        public void CetakData(bool pi, int banyakbit)
        {
            //Print table header
            Console.Write("N\t\t");
        ...
        public void CariEPI(int[] minterm)
        {
            ...
            for (int a3 = 1; a3 <= jumlahpers; a3++)
            {
                ...
                //Console.WriteLine("Iterasi Ke - " + a3);
        ...
        public bool BacktrackEPI(int[,] tabelepi, int[] minterm, int jumlahpers, int jumlahmin, string[] epibin, string[] tempbin, int urut, int index, int[,] indexsementara, int posisi)
        {
			...
			*/
			...
			//Memberi hanya salah satu solusi saja !!!
            return (BacktrackEPI(tabelepi, minterm, jumlahpers, jumlahmin, epibin, tempbin, urut, index + 1, indexsementara, posisi + 1) || BacktrackEPI(tabelepi, minterm, jumlahpers, jumlahmin, epibin, tempbin, urut, index, indexsementara, posisi + 1));
        }
    ...
    class Mahayadnya
    {
        ...
        static void Main(string[] args)
        {
            ...
            ayng.CetakData(false, banyakbit);
